...
<script lang="ts">
  ...
  export let activeTool: Tool = Tool.Pen;
</script>

<!-- TODO center toolbar right -->
<div class="flex justify-center pt-1 w-full">
  <!-- svelte-ignore a11y-no-static-element-interactions -->
  <!-- svelte-ignore a11y-click-events-have-key-events -->
  <div class="flex bg-primary rounded-lg justify-between">
    <div class="flex py-2 px-4 space-x-3 items-center">
      <svg
        class="anim"
        on:click={() => (activeTool = Tool.Pen)}
        xmlns="http://www.w3.org/2000/svg"
        height={activeTool === Tool.Pen ? "120%" : "80%"}
        viewBox="0 0 24 24"
        fill="none"
      >
        <path
      ...
      <svg
        class="anim"
        on:click={() => (activeTool = Tool.Tweezers)}
        height={activeTool === Tool.Tweezers ? "120%" : "80%"}
        viewBox="0 0 24 24"
        id="Layer_1"
        data-name="Layer 1"
        xmlns="http://www.w3.org/2000/svg"
        ...
        /><g id="SVGRepo_iconCarrier"
          ...
          ><path
            class="cls-1"
            d="M6.34,17.73h0a6.9,6.9,0,0,1,2-4.89L14,7.23l2.86,2.86L11.23,15.7A6.92,6.92,0,0,1,6.34,17.73Z"
          /><path
            class="cls-1"
            d="M17.32,10.57,13.5,6.75,18,2.29a2.69,2.69,0,0,1,1.91-.79h0a2.7,2.7,0,0,1,2.7,2.7h0a2.73,2.73,0,0,1-.79,1.91Z"
          /><line class="cls-1" x1="12.07" y1="5.32" x2="18.75" y2="12" /><path
            class="cls-1"
            d="M6.34,21.55a1,1,0,0,1-1.91,0,6.27,6.27,0,0,1,1-1.91A6.29,6.29,0,0,1,6.34,21.55Z"
          /></g
        ></svg
      >
      <svg
        on:click={() => (activeTool = Tool.Eraser)}
        height={activeTool === Tool.Eraser ? "120%" : "80%"}
        class="anim"
        viewBox="0 0 24 24"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <div
      class="flex h-8 bg-primary rounded-lg px-2 justify-evenly items-center"
    >
      <button
        class="btn btn-xs btn-ghost font-normal normal-case text-sm hover:bg-base-content hover:text-neutral px-5 text-neutral-content"
